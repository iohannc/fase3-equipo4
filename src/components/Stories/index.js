...
const Stories = (props) => {
  const listHist = props.listHist;
  listHist.map(item => console.log(listHist));
  ...
  //     texto:
  //       "A mediados del 2009 me encontraba con mi familia, más especificamente, mi hermana y mi cuñada, utilizando YouTube e indagando en los vídeos paranormales. Era la época dónde todo eso estaba en alza, e... ",
  //   },
  //   {
  //     _id: "614811fdbda6bed2a49738e8",
  //     titulo: "La estatua del payaso",
  //     texto:
  //       "María Luisa llegó a la casa del doctor Reyes y su esposa a eso de las 7 de la noche. Había sido contratada para cuidar los dos hijos de la pareja mientras ellos cenaban en un lujoso restaurante de la... ",
  //   },
  //   {
